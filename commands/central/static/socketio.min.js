// Cached code from socket.io project, see github.com/socketio
!function(t) {
                        ...
                        f || (a('probe transport "%s" opened', t), u.send([{
                            ...
                            if (!f)
                                if ("pong" == e.type && "probe" == e.data) {
                                    if (a('probe transport "%s" pong', t), h.upgrading = !0, h.emit("upgrading", u), !u)
                                        return;
                ...
                !function(o) {
                    ...
                    function s(t) {
                        for (var e, n = t.length, r = -1, o = ""; ++r < n;)
                            e = t[r], e > 65535 && (e -= 65536, o += b(e >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), o += b(e);
                        return o
                    }
                    function a(t, e) {
                        return b(t >> e & 63 | 128)
                                ...
                                if ("object" == typeof f && f)
                                    if (h = a.call(f), h != d || o.call(f, "toJSON"))
                                        ...
                                        if (x) {
                                            ...
                                            l = f.getUTCFullYear(), b = f.getUTCMonth(), k = f.getUTCDate(), B = f.getUTCHours(), C = f.getUTCMinutes(), S = f.getUTCSeconds(), T = f.getUTCMilliseconds();
                                    ...
                                    case 34:
                                        for (t = "@", P++; s > P;)
                                            if (o = i.charCodeAt(P), 32 > o)
                                                ...
                                                case 117:
                                                    for (e = ++P, n = P + 4; n > P; P++)
                                                        o = i.charCodeAt(P), o >= 48 && 57 >= o || o >= 97 && 102 >= o || o >= 65 && 70 >= o || q();
                                                    t += N("0x" + i.slice(e, P));
                                                    break;
                                                default:
                                                    q()
